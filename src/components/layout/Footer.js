    ...
    <div className="container">
      <div className="footer">
        <div className="footer-item">
          ...
          <h3 className="footer-item__title footer-item__title--one ex-bold">
            О нашем проекте
          </h3>
        ...
        <div className="footer-item">
          <h3 className="footer-item__title ex-bold">Меню</h3>
        ...
        <div className="footer-item">
          <h3 className="footer-item__title ex-bold">Мы в соц. сетях</h3>
          <p className="footer-item__desc">
            Lorem Ipsum - это текст-"рыба", часто используемый в печати и
            вэб-дизайне. Lorem Ipsum является
          </p>
          <ul className="social footer-social list-reset">
