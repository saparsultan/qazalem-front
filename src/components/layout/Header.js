...
const Header = ({ lng }) => {
  ...
  console.log("lng", lng);
  console.log("title-header", t("title"));
  return (
    <header
      className={
      ...
      <div className="container">
        <div className="header">
          ...
          <div className="header-actions">
            {/*<Link href={`/${lng}/sign-up`} className="btn btn-reset btn-reg">*/}
            {/*  {t("registration")}*/}
            {/*</Link>*/}
            {/*<Link href={`/${lng}/login`} className="btn btn-reset btn-login">*/}
            {/*  {t("login")}*/}
            {/*</Link>*/}
            <div className="user-wrap">
              <div className="user">
                <div className="user-content">
                  ...
                  <div className="user-content__text">Арман</div>
                </div>
                <svg
