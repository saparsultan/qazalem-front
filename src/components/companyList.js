      ...
      <div className="container">
        <div className="company-list">
          <h2 className="title title-h2 company-list__title">
            ВНЕСИ СВОЙ ВКЛАД <br /> В РАЗВИТИЕ КАЗАХСТАНА
          </h2>
                ...
                <div className="company-list-content">
                  <div className="company-list-content__item">
                    ...
                    <p className="company-list-content__desc">
                      Lorem Ipsum - это, часто используемый в печати и
                      вэб-дизайне. Lorem I psum является стандартной рыбой для
                ...
                <div className="company-list-content">
                  <div className="company-list-content__item">
                    ...
                    <p className="company-list-content__desc">
                      ...
                      и вэб-дизайне. Lorem I psum является стандартной рыбой для
                      текстов на латинице с начала XVI века. В то время некий
                      текстов на латинице с начала XVI века. В то время некий
                    </p>
                    <Link
