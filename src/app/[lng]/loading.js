    ...
    <div className="loader">
      ...
      >
        <defs>
          ...
          <linearGradient id="loader-icon-grad2" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="hsl(313,90%,55%)" />
            <stop offset="100%" stopColor="hsl(223,90%,55%)" />
          </linearGradient>
        </defs>
        ...
        />
        <line
          className="loader-icon__ball"
          stroke="url(#loader-icon-grad2)"
          x1="100"
          y1="18"
          x2="100.01"
          y2="182"
